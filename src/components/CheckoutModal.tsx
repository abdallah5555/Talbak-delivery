      ...
      <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 animate-fade-in">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-5 overflow-y-auto space-y-4 flex-1">
            ...
            <div className="space-y-2 pt-2 border-t border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`p-3 rounded-2xl border text-center transition-all ${paymentMethod === 'cash' ? 'bg-orange-50 border-orange-500 text-orange-900 shadow-sm' : 'bg-slate-50 border-slate-200 text-slate-700 hover:bg-slate-100'}`}
                >
            ...
            >
              {isSubmitting ? 'جاري إرسال الطلب...' : <><CheckCircle2 className="w-5 h-5" /><span>تأكيد وإرسال الطلب الآن</span></>}
            </button>
          </form>
        </motion.div>
      </div>
